...
{
    c4_install_str(c, "define(ping, {@string, string, int});");
    c4_install_str(c, "define(done, {int});");
...
{
    c4_install_str(c, "define(t, {int});");
    c4_install_str(c, "define(b, {int, int});");
    c4_install_str(c, "define(c, {int, int});");
