...
AstTableRef *make_table_ref(const char *name, List *cols, apr_pool_t *pool);
...
AstVarExpr *make_var_expr(const char *name, DataType type, apr_pool_t *pool);
AstConstExpr *make_const_expr(AstConstKind c_kind, const char *value, apr_pool_t *pool);

FilterPlan *make_filter_plan(List *quals, const char *tbl_name, apr_pool_t *pool);
InsertPlan *make_insert_plan(AstTableRef *head, bool is_network, apr_pool_t *pool);
ScanPlan *make_scan_plan(List *quals, const char *tbl_name, apr_pool_t *pool);
